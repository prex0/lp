...
import { DevicePasskeySupport } from "@prex0/uikit/wallet";
import { ComponentDetail } from "../common/ComponentDetail";

const Code = `import { DevicePasskeySupport } from "@prex0/uikit/wallet";

export function DevicePasskeySupportExample() {
  return (
    <DevicePasskeySupport notSupportedComponent={<div>Not supported</div>}>
      <div>Supported</div>
