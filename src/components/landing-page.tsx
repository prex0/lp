...
const initialEdges: Edge[] = [
  ...
  { 
    ...
    style: { stroke: "#fff" },
    label: "Sign Order",
    labelStyle: { fill: "#fff", fontWeight: 700, fontFamily: "Satoshi, sans-serif" },
...
function FeatureColumn({ icon, title, description }: { icon: React.ReactNode; title: string; description: string }) {
  return (
